...
function Profile1() {
  ...
  useEffect(() => {
    if (file) {
      handleFileUpload(file); // Pass the file parameter
    }
  }, [file]); // Add formData to dependency array
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        />
        <button 
          disabled={loading} className='bg-slate-800 text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80'
        >
