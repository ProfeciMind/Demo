...
function Search() {
  ...
  const onShowMreClick=async ()=>{
    const numberofListings = listings.length;
    const startIndex= numberofListings;
    const urlParams=new URLSearchParams(loaction.window);
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1">
        <h1 className="text-3xl font-semibold border-b p-3 text-slate-700 my-5">
          Listing Results :
        </h1>
